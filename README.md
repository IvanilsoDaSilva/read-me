...
[Link para a Seção Interessante](#teste)
[Link para a Seção Interessante](#teste-teste)
...
<h2 style="visibility:hidden">teste</h2>

<h2 style="visibility:hidden">{"dataname":"environment","colvar":"varname","colval":"value"}>teste teste</h2>
